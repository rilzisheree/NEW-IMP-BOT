...
export default {
  data: new SlashCommandBuilder()
    .setName('loreteam')
    .setDescription('Set the Loreteam role that gets access to all LT commands. (Bot owners only)')
    .addRoleOption(opt =>
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`Members with <@&${role.id}> now have access to all LT valor commands.`)
      .addFields(
